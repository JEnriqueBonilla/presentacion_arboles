...
Cada uno de estos enfoques es útli en distintas situaciones. 
...
- **Aprendizaje estadístico**: teoría estadística detras de
las últimas dos.
...
- **Aprendizaje Supervisado**: predecir variable dada $Y$ 
    ...
    númerica, se conoce como problema de *regresión*. 
...
Se trata de encontar estructuras intrisecas en los datos.
