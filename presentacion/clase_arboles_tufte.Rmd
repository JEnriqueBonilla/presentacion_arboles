...
Esta descomposición nos muestra cómo, para minimizar el error de
...
el espacio de las covariables (feature space) en rectángulos 
por medio de modelos simples, cómo constantes. En esta 
sección, nos enfocaremos en el enfoque *CART*^[@breiman1984classification]. Aunque este 
tipo de árboles, por si solos, son fácilmente superados 
en la predicción, construyen la base de técnicas muy poderosas 
...
manera y así sucesivamente. Los nodos terminales representan la partición
obtenida. 
...
de interpretar. Además, como se puede ver en los árboles binarios, este modelo
permite capturar interaccciones. 
...
Ahora queda por responder las siguientes pregutas: ¿Cómo hacer las 
