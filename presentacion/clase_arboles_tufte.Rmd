...
sección, nos enfocaremos en el enfoque *CART*^[@breiman1984classification]. 
...
de casos que clasificaste mal respecto a la categoría
más frecuente en el nodo.

$$i(t) = 1 - \underset{j}{\text{max}}(p_j(t))$$

Cuando $K=2$ estás 3 medidas se comportan similarmente.
...
Como vimos, los árboles de clasificación 
